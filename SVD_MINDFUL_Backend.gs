...
6. **レストランには幸せしかない**: これはサービスを行う上での絶対的な精神性。レストランという場所は、お客様にとっても、働く仲間にとっても、幸せしか存在しない場所であるべき。この信念がすべてのサービスの原点
7. **人材版グランドホテルシステム**: SVDは世界中で活躍するサービスマンや料理人を輩出する「人材のグランドホテル」。ここで働いた経験が、世界のどこでも通用するパスポートになる。SVDから羽ばたいた人材が世界各地で輝くことが、私たちの誇り
